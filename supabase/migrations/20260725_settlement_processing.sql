-- DreamFund
-- Stripe上の未確定決済をサーバー側で確認したあと、
-- プロジェクトの成立・不成立を最終ロックし、
-- All or Nothing未達成時の返金レコードを原子的に作成する。
...
begin
  ...
  -- All or Nothing未達成時だけ、paid支援ごとの返金レコードを作成する
